...
public class SauceConnectManager implements TunnelManager<SauceConnectOptions>
{
            ...
            try
            {
                ...
                synchronized (sauceTunnelManager)
                {
                    sauceTunnelManager.openConnection(sauceLabsUsername, sauceLabsAccessKey, sauceLabsDataCenter,
                            findFreePort(), null, sauceConnectDescriptor.getOptions(), LOGGER, System.out, Boolean.TRUE,
                            null, true);
                }
            }
            catch (IOException e)
    ...
    private int findFreePort() throws AbstractSauceTunnelManager.SauceConnectException
    {
        ...
        {
            throw new AbstractSauceTunnelManager.SauceConnectException("Unable to find free port", e);
        }
    }
