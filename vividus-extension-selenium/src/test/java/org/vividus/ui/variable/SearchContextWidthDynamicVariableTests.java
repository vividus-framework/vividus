...
class SearchContextWidthDynamicVariableTests
{
    ...
    @InjectMocks private SearchContextWidthDynamicVariable dynamicVariable;
    ...
    void shouldReturnElementHeight()
    {
        ...
        assertEquals(DynamicVariableCalculationResult.withValue("1917"), dynamicVariable.calculateValue());
    }
