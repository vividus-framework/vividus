...
class SearchContextXCoordinateDynamicVariableTests
{
    ...
    @InjectMocks private SearchContextXCoordinateDynamicVariable dynamicVariable;
    ...
    void shouldReturnElementHeight()
    {
        ...
        assertEquals(DynamicVariableCalculationResult.withValue("1924"), dynamicVariable.calculateValue());
    }
