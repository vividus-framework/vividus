...
class SearchContextHeightDynamicVariableTests
{
    ...
    @InjectMocks private SearchContextHeightDynamicVariable dynamicVariable;
    ...
    void shouldReturnElementHeight()
    {
        ...
        assertEquals(DynamicVariableCalculationResult.withValue("711"), dynamicVariable.calculateValue());
    }
