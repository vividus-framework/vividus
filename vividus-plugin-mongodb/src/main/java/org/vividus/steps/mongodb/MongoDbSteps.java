...
import org.vividus.steps.mongodb.command.CommandType;
...
public class MongoDbSteps
{
    ...
    public MongoDbSteps(Map<String, String> connections, JsonUtils jsonUtils, VariableContext variableContext)
    {
    ...
    private <T> UnaryOperator<T> putVariable(Set<VariableScope> scopes, String variableName)
    {
        return r ->
        {
            variableContext.putVariable(scopes, variableName, r);
            return r;
        };
    }
