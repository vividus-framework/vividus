...
class ResponseAsBytesDynamicVariableTests
{
    @Mock private HttpTestContext httpTestContext;
    @InjectMocks private ResponseAsBytesDynamicVariable responseDynamicVariable;
    ...
    void shouldReturnResponseBodyAsString()
    {
        ...
        assertArrayEquals(responseBody,
            (byte[]) responseDynamicVariable.calculateValue().getValueOrHandleError(null).get());
    }
