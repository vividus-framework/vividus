...
<div class="modal fade" id="modal_${hash}" tabindex="-1" aria-labelledby="modalLabel_${hash}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalLabel_${hash}">Response body</h4>
