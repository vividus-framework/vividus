...
public class HttpRequestSteps
{
     ...
     * HTTP request header with name 'Content-Type' and value 'application/x-www-form-urlencoded; charset=ISO-8859-1' is set.
     * <div>Example:</div>
     * <code>
    ...
    public void putUrlEncodedRequest(ExamplesTable parameters)
    {
        ...
        httpTestContext.putRequestEntity(
                new StringEntity(URLEncodedUtils.format(listOfParams, StandardCharsets.UTF_8), ContentType.APPLICATION_FORM_URLENCODED));
    }
