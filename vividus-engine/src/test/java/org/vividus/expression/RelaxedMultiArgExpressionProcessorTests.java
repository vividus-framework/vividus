...
class RelaxedMultiArgExpressionProcessorTests
{
    ...
    {
        var processor = new RelaxedMultiArgExpressionProcessor<>(EXPRESSION_NAME, 2, EVALUATOR);
    ...
    {
        var processor = new RelaxedMultiArgExpressionProcessor<>(EXPRESSION_NAME, 2, 3, EVALUATOR);
        var actual = processor.execute(expression);
        assertEquals(Optional.of(expected), actual);
    }
