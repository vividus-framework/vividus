...
public class IssueLinkSerializer extends JsonSerializer<IssueLink>
{
    private static final String KEY = "key";

    @Override
    public void serialize(IssueLink issueLink, JsonGenerator generator, SerializerProvider serializers)
            throws IOException
    {
