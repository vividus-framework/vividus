...
class XrayFacadeTests
{
    ...
    void shouldCreateTestsLink() throws IOException, JiraConfigurationException
    {
        ...
        verify(jiraFacade).createIssueLink(ISSUE_ID, requirementId, linkType, Optional.empty());
    ...
    void shouldUpdateManualTestCase() throws IOException, NonEditableIssueStatusException, JiraConfigurationException
    {
        ...
        when(jiraFacade.getIssueStatus(ISSUE_ID, Optional.empty())).thenReturn(OPEN_STATUS);

        xrayFacade.updateTestCase(ISSUE_ID, testCase);

        verify(jiraFacade).updateIssue(ISSUE_ID, BODY, Optional.empty());
    ...
    void shouldUpdateTestCaseNotEditableStatus() throws IOException, JiraConfigurationException
    {
        ...
        when(jiraFacade.getIssueStatus(ISSUE_ID, Optional.empty())).thenReturn(closedStatus);
    ...
    void shouldAddTestCasesToTestExecution() throws IOException, JiraConfigurationException
    {
        ...
        when(jiraClientProvider.get(ISSUE_KEY, Optional.empty())).thenReturn(jiraClient);
    ...
    {
        xrayFacade = new XrayFacade(editableStatuses, Optional.empty(), jiraFacade, jiraClientProvider,
