...
class JsonContextVariableTests
{
    @Mock private JsonContext jsonContext;
    @InjectMocks private JsonContextVariable variable;
    ...
    void shouldReturnResponseBodyAsString()
    {
        ...
        assertEquals(DynamicVariableCalculationResult.withValue(json), variable.calculateValue());
    }

    @Test
    void shouldReturnErrorWhenNoJsonContextPresent()
    {
        when(jsonContext.getJsonContext()).thenReturn(null);
        assertEquals(DynamicVariableCalculationResult.withError(
