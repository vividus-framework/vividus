...
|Time.between 'null','null'
|error

|Time.between 'null','null','value'
|error

|Time.future '5','null'
|error

|Time.future '5','null','value'
|error

|Time.future '5','5','null','value'
|error

|Time.future '5','5','null'
|error

|Time.past '5','5','null','value'
|error
...
|Tron.alternateCharacterSpelling 'null'
|error
...
|Twitter.text 'null','5','5'
|error
|Twitter.createdTime 'true','null','null'
|error
