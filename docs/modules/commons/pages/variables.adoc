...
.Validate the name of the currently running story
[source,gherkin]
----
Then `${running-story}` is equal to `MyStory`
----
...
.Validate the name of the currently running scenario
[source,gherkin]
----
Then `${running-scenario}` is equal to `Verify search functionality`
----
