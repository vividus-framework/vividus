...
WARNING: If the variables contain valid numbers than they will be converted into {java-api-docs-base-url}/docs/api/java.base/java/math/BigInteger.html[BigInteger] and compared as numbers.
