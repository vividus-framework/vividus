...
The variable returns the name of the currently running story (the file name of the story without the `.story` extension).
...
.Save the name of the currently running story into a variable
[source,gherkin]
----
Given I initialize scenario variable `storyName` with value `${running-story-name}`
Then `${storyName}` is equal to `MyStory`
----

=== Running scenario name

The variable returns the title of the currently running scenario.
...
.Save the name of the currently running scenario into a variable
[source,gherkin]
----
Given I initialize scenario variable `scenarioName` with value `${running-scenario}`
Then `${scenarioName}` is equal to `Verify search functionality`
----
