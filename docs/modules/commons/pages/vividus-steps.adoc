...
* `$fileName` - The name of the file to check (e.g. report_20231015.xlsx)
...
When I create temporary file with name `report_20231015.xlsx` and content `${temp-file-content}` and put path to scenario variable `temp-file-path`
Then file with name `report_20231015.xlsx` exists by path `temp-file-path`----
