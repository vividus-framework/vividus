...
IMPORTANT: filtering by regex is not allowed to be used together with the following properties: `byMaxColumns`, `byColumnNames`, `byMaxRows`, `byRowIndexes`, `byRandomRows`.
