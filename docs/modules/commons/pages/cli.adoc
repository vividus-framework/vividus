...
For files like *.story, *.steps, *.table, and others commonly used in BDD and test automation, basic Spotless rules typically include:
...
|Enforces spaces or tabs for indentation, often set to 2 or 4 spaces.

|Normalizing Line Endings
|Converts all line endings to LF (\n) for consistency across platforms.

|Removing Extra Blank Lines
|Limits consecutive blank lines to a maximum (often 1).
|===
...
* What went wrong:
Execution failed for task ':vividus-tests:spotlessVividusCheck'.
> The following files had format violations:
      src/main/resources/story/integration/Precondition.story
          @@ -2,4 +2,4 @@
           ····@epic·vividus-engine
...
[source,shell]
----
Run './gradlew :vividus-tests:spotlessApply' to fix these violations.
----
...
[source,shell]
----
./gradlew :vividus-tests:spotlessApply
----
Windows::
+
[source,shell]
...
----
======
. This will automatically fix the format violations in the affected files.
. Review the changes that were applied and commit them to your repository.
