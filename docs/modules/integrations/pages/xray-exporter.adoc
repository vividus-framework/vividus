...
|false
|The key of a `Test Execution` to which the exported test cases will be added
...
:jar-link: https://oss.jfrog.org/oss-snapshot-local/org/vividus/vividus-to-xray-exporter/{current-version}/vividus-to-xray-exporter-{current-version}.jar
endif::[]
ifeval::["{release-version}" == "true"]
:jar-link: https://jcenter.bintray.com/org/vividus/vividus-to-xray-exporter/{current-version}/vividus-to-xray-exporter-{current-version}.jar
endif::[]
