...
. Optionally, add the Playwright MCP server to enable browser control and web-application test generation: <2>
+
[source,bash]
----
...
[source]
----
Refactor these test scenarios to follow data-driven approach and add examples tables to add variety of test data.
----
======
