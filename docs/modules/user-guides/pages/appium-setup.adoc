...
How to work with iOS simulator
include::plugins:partial$mobile-ios-simulator.adoc[]

How to work with Android emulator
include::plugins:partial$mobile-android-emulator.adoc[]
