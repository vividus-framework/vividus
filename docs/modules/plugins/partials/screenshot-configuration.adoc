** `shootingStrategy` - The <<_shooting_strategies, shooting strategy>> to use.
...
** `textToMask` - The text to be masked with placeholder before capturing the page screenshot and reverted back after capturing is finished. *(Web only)*
