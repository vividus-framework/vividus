...
Allows to set command line arguments for browsers. https://peter.sh/experiments/chromium-command-line-switches/[List of supported commands for Chrome browser]

IMPORTANT: Step should be used before start ot the browser session
