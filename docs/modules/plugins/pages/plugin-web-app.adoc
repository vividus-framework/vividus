...
|https://peter.sh/experiments/chromium-command-line-switches/[Chromium Command Line Switches]
https://www-archive.mozilla.org/docs/command-line-args/[Mozilla Command Line Options]
https://docs.microsoft.com/en-us/previous-versions/windows/internet-explorer/ie-developer/general-info/hh826025(v=vs.85)?redirectedfrom=MSDN/[IE Command Line Options]
|empty
|Command line options used to specify various startup options for CHROME, FIREFOX and IE browsers 
