...
[source,gradle]
----
implementation(group: 'com.microsoft.sqlserver', name: 'mssql-jdbc', version: '11.2.0.jre11')
----
...
[source,gradle]
----
implementation(group: 'net.snowflake', name: 'snowflake-jdbc', version: '3.13.21')
----
