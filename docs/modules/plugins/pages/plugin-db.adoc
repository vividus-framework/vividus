...
[source,gradle]
----
implementation(group: 'net.snowflake', name: 'snowflake-jdbc', version: '3.13.26')
----
...
* `$leftSqlQuery` - The https://www.techtarget.com/searchdatamanagement/definition/SQL[SQL query to execute] to retrieve baseline result set.
* `$leftDbKey` - The <<_database_connection, database connection key>> for baseline result set.
* `$comparisonRule` - xref:parameters:comparison-rule.adoc[The comparison rule].
* `$rightSqlQuery` - The https://www.techtarget.com/searchdatamanagement/definition/SQL[SQL query to execute] to retrieve checkpoint result set.
* `$rightDbKey` - The <<_database_connection, database connection key>>. for checkpoint result set.
