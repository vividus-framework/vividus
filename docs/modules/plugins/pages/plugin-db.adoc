...
[source,gradle,subs="attributes+"]
----
include::example$plugin-db/postgresql-dependency/build.gradle[]
----
+
...
[source,gradle]
----
include::example$plugin-db/mysql-dependency/build.gradle[]
----
...
[source,gradle]
----
include::example$plugin-db/sqlserver-dependency/build.gradle[]
----
...
[source,gradle]
----
include::example$plugin-db/oracle-dependency/build.gradle[]
----
...
[source,gradle]
----
include::example$plugin-db/csvjdbc-dependency/build.gradle[]
----
...
[source,gradle]
----
include::example$plugin-db/h2-dependency/build.gradle[]
----
...
[source,gradle]
----
include::example$plugin-db/snowflake-dependency/build.gradle[]
----
