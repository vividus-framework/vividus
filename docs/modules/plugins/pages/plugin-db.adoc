...
- Choose and open version (https://mvnrepository.com/artifact/org.postgresql/postgresql/42.5.3[42.5.3]);
...
[source,properties]
----
db.connection.vividus.url=jdbc:sqlserver://;serverName=mssql.db.server;databaseName=my_database;encrypt=true;trustServerCertificate=true
db.connection.vividus.username=vividus
db.connection.vividus.password=pa$$w0rd
----
...
[source,properties]
----
jdbc:sqlserver://;servername=server_name;encrypt=true;integratedSecurity=true;parameter1=value1;parameter2=value2
----
====
...
[source,gradle]
----
implementation(group: 'net.snowflake', name: 'snowflake-jdbc', version: '3.13.27')
----
