...
[source,gradle]
----
implementation(group: 'com.microsoft.sqlserver', name: 'mssql-jdbc', version: '12.3.0.jre11')
----
...
[source,gradle]
----
implementation(group: 'net.snowflake', name: 'snowflake-jdbc', version: '3.13.32')
----
