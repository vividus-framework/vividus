...
Switches context to a web view by the index, it starts from 1. See http://appium.io/docs/en/writing-running-appium/web/hybrid/[Automating hybrid apps] for more information.
