...
In order to validate the body of the latest HTTP response use the <<_response>> dynamic variable to access the body
...
in conjunction with the <<_response>> dynamic variable, it might be useful if you want to preserve the data for further computations since each
