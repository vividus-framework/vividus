...
=== Set application/x-www-form-urlencoded HTTP request
...
Default HTTP request header with name `Content-Type` and value `application/x-www-form-urlencoded; charset=ISO-8859-1` is set.
...
* `$parameters` - any valid ExamplesTable.
