...
Validates JSON against https://spec.openapis.org/oas/v3.0.0[OpenAPI schema version 3.0].
...
* `$json` - The JSON to validate.
* `$schema` - https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.0.md#schema-object[The OpenAPI schema].

[IMPORTANT]
====
https://swagger.io/docs/specification/data-models/keywords/[OpenAPI 3.0] uses an extended subset of https://json-schema.org/specification-links#draft-4[JSON Schema Specification v4] to describe the data formats.
====
