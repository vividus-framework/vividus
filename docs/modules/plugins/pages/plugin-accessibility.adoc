...
** `locators` - The comma-separated xref:vividus:plugins:plugin-web-app.adoc#_locator[locators] of elements to verify
** `elementsToIgnore` - The comma-separated xref:vividus:plugins:plugin-web-app.adoc#_locator[locators] of elements to ignore
