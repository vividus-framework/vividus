...
** [subs=+quotes]`*standard*` - The tag of accessibility standard to check a page against, the list of available tags can be found https://www.deque.com/axe/core-documentation/api-documentation/#axe-core-tags[here].
