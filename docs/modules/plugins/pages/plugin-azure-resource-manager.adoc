...
Firstly, need to https://learn.microsoft.com/en-us/azure/key-vault/general/quick-create-portal#create-a-vault[create Key Vault in Azure].
Then you will able to https://learn.microsoft.com/en-us/azure/key-vault/secrets/quick-create-portal[add/read/update/remove secrets] in existing Key Vault.
...
|[subs=+quotes]`*azure.key-vault.url*`
|Azure Key Vault name
|`https://autotestkeyvault.vault.azure.net/`
