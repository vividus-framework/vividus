...
|[subs=+quotes]`*ssl-labs.email*`
|`string`
|`<empty>`
|The email address registered via the https://github.com/ssllabs/ssllabs-scan/blob/master/ssllabs-api-docs-v4.md#register-for-scan-api-initiation-and-result-fetching-[SSL Labs registration API].
