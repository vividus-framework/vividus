...
|
|Used to specify a list of glob patterns for hosts that are connected-to directly, others are connected through the SauceConnect. By default the list inicludes `*.miso.saucelabs.com`, `*.api.testobject.com`, `*.saucelabs.com`, `saucelabs.com` host patterns.
