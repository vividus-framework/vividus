...
Some of the plugins, like xref:plugins:plugin-web-app.adoc[web-app], have built-in profiles. You can find them in project explorer after installation by the following path:
...
Please see <<_externalized_configuration>> to find the ways how encryptor password can be passed to the tests.
