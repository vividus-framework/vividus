...
:key-store-ref: {java-api-docs-base-url}/security/terms-and-definitions.html#GUID-C7BB21C7-E19E-4DE4-8494-CB43F957C329__GUID-D7CAC72A-2714-4C9B-88E2-7F317DE94CEE[key store]
...
|`http.key-store.type`
|{java-api-docs-base-url}/docs/specs/security/standard-names.html#keystore-types[KeyStore types]
|`JKS`
