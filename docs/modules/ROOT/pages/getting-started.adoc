...
== Get an existing tests project from GitHub
. Login to http://github.com/[GitHub] (create a new account at first if you don't have any).
. Navigate to the target VIVIDUS tests repo page (e.g. https://github.com/vividus-framework/vividus-sample-tests)
. Create a fork of the target tests repo to be able to execute & modify scripts at your convenience:
- click 'Fork' icon at the top-right corner of the screen
- the pre-populated values cover the avg. user needs, so just click 'Create a fork' button.
- as the result you now have a copy of the target tests repo at your personal GitHub folder.
. Clone your newly generated repository:
+
[source,shell]
----
...
==== Prerequisites
. Install https://www.eclipse.org/downloads/packages/release/2022-12/r/eclipse-ide-java-developers[Eclipse IDE 2022-12]
...
. https://help.eclipse.org/2022-12/index.jsp?topic=%2Forg.eclipse.platform.doc.user%2Ftasks%2Ftasks-importproject.htm[Import the project to Eclipse]
