...
. Create a fork of the target tests repo to be able to execute & modify scripts at your convinience:
- click 'Fork' icon at the top-right corner of the screen
- the prepopulated values cover the avg. user needs, so just click 'Create a fork' button. 
