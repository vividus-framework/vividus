...
. Tune http://web.archive.org/web/20230329174755/https://testingfreak.com/how-to-fix-cross-origin-request-security-cors-error-in-firefox-chrome-and-ie/[CORS option in the browser of your choice].
+
