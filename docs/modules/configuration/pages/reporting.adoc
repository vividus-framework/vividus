...
[source,properties]
----
environment-configurer.static.<data-identifier>.description=<description>
environment-configurer.static.<data-identifier>.value=<value>
environment-configurer.static.<data-identifier>.category=<category>
environment-configurer.static.<data-identifier>.add-to-report=<show-in-report>
----
...
[source,properties]
----
environment-configurer.static.visual-action.description=Visual Action
environment-configurer.static.visual-action.value=${variables.visual-action}
environment-configurer.static.visual-action.category=ENVIRONMENT
----

Dynamic data format:
[source,properties]
----
environment-configurer.dynamic.<data-identifier>.description=<description-pattern>
environment-configurer.dynamic.<data-identifier>.propertyRegex=<property-regex>
environment-configurer.dynamic.<data-identifier>.category=<category>
environment-configurer.dynamic.<data-identifier>.add-to-report=<show-in-report>
----
...
[source,properties]
----
environment-configurer.dynamic.batch-location.description=Batch %s Location
