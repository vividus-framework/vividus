...
{
    private final XpathSearch search = new XpathSearch();
    ...
    void testSearch()
    {
        ...
        when(searchContext.findElements(By.xpath(parameters.getValue()))).thenReturn(elements);
    ...
    {
        assertEquals(WebLocatorType.XPATH, search.getType());
    }
}
