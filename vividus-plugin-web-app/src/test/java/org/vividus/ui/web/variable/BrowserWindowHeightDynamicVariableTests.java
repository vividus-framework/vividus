...
class BrowserWindowHeightDynamicVariableTests
{
    @Mock private IWebDriverProvider webDriverProvider;
    @Mock private IGenericWebDriverManager webDriverManager;
    @InjectMocks private BrowserWindowHeightDynamicVariable dynamicVariable;

    @Test
    void shouldReturnWindowHeight()
    {
        ...
        when(dimension.getHeight()).thenReturn(911);

        assertEquals(DynamicVariableCalculationResult.withValue("911"), dynamicVariable.calculateValue());
    }
