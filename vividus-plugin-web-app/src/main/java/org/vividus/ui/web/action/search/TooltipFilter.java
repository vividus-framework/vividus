...
public class TooltipFilter extends ByLocatorSearch implements IElementFilterAction
{
    private static final Logger LOGGER = LoggerFactory.getLogger(TooltipFilter.class);
    ...
    {
        LOGGER.warn("'tooltip' filter is deprecated  and will be removed in VIVIDUS 0.7.0");
