...
public class DeviceDependentScreenshotShootingStrategy implements ScreenshotShootingStrategy
{
    @Override
    ...
    {
        return Device.getByDeviceName(deviceName).decorate(landscape);
    }
}
