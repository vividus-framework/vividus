...
|ESTABLISH|xpath((.//p)[1])   |Vividus System Tests|
...
|profile                |browserType|viewportSize|deviceName|
...
|ufg-full-page-element-cut |<batchName>|<action>|tagName(img)    |
 and matrix:
|profile                |browserType|viewportSize|deviceName|screenOrientation|version|
