                            ...
                            <table class="table table-hover">
                                ...
                                <#if testResult.getAccessibilityCheckResult()??>
                                    ...
                                    <tr class="${accessibilityStatus}">
                                        <td class="inner-cell">
                                            ${accessibilityResult.getVersion()} - ${accessibilityResult.getLevel()} accessibility check is ${accessibilityResult.getStatus()}, see <a href="${accessibilityResult.getUrl()}" role="button">Applitools report</a> for details.
                                        </td>
                                    </tr>
                                </#if>
                            </table>
