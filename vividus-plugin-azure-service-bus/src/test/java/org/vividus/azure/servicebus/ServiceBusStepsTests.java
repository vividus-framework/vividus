...
public class ServiceBusStepsTests
{
    ...
    @InjectMocks private ServiceBusSteps serviceBusSteps;
    ...
    void testSendMessageToServiceBus()
    {
        ...
        String name = "name";
        String msg = "msg";
        serviceBusSteps.sendMessageToServiceBus(ChannelType.QUEUE, name, namespace, msg);
        verify(serviceBusService).send(ChannelType.QUEUE, name, namespace, msg);
    }
}
