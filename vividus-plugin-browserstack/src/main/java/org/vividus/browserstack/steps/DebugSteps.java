...
package org.vividus.browserstack.steps;
...
public class DebugSteps
{
    ...
    public DebugSteps(BrowserStackAutomateClient appAutomateClient, VariableContext variableContext,
    ...
    {
        variableContext.putVariable(scopes, variableName, getNetworkLogs());
    }
    ...
    {
        testContext.put(PREVIOUS_SESSION_ID, event.sessionId());
    }
}
