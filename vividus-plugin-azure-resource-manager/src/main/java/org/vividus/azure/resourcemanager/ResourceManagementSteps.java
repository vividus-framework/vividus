...
{
    private final AzureResourceManagerClient client;
    private final VariableContext variableContext;
    private final ISoftAssert softAssert;

    public ResourceManagementSteps(AzureResourceManagerClient client, VariableContext variableContext,
            ...
            String azureOperationBody, Set<VariableScope> scopes, String variableName)
    {
        client.executeHttpRequest(HttpMethod.POST, azureOperationIdentifier, apiVersion,
                Optional.of(azureOperationBody), responseBody ->
