...
public class AzureKeyVaultPropertiesProcessor extends AbstractPropertiesProcessor
{
    ...
    private static final String KEY_VAULT_PROCESSOR_ENABLED_PROPERTY =
            "secrets-manager.azure-key-vault.processor.enabled";
    ...
    public Properties processProperties(Properties properties)
    {
        ...
        this.setProcessorEnabled(Boolean.parseBoolean(properties.getProperty(KEY_VAULT_PROCESSOR_ENABLED_PROPERTY)));
