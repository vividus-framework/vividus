...
public class AzureResourceManagerClient
{
    ...
    /**
     * Executes an HTTP request to the specified URL using the provided parameters.
     * This method allows for flexible error handling based on the availability of a soft assertion mechanism.
     * If softAssert is available, it uses soft assertions to handle errors; otherwise,
                                    ...
                                    Consumer<String> responseBodyConsumer)
    {
        ...
        executeHttpRequest(method, azureResourceUrl, azureResourceBody, responseBodyConsumer, errorCallback);
    }
