...
class ByAppiumLocatorSearchTests
{
    @Test
    void testSearch()
    {
        ...
        ByAppiumLocatorSearch search = new ByAppiumLocatorSearch(AppiumLocatorType.XPATH, AppiumHow.XPATH);

        when(searchContext.findElements(AppiumHow.XPATH.buildBy(parameters.getValue()))).thenReturn(webElements);
