...
{
    private static final String IOS_ERROR_MESSAGE = "%s is not supported for iOS";
    ...
    void shouldFailForEnableNetworkConnectionForNotIOS(Mode mode)
    {
        ...
        assertEquals(String.format(IOS_ERROR_MESSAGE, mode), iae.getMessage());
    }

    @ParameterizedTest
    @EnumSource(value = Mode.class, names = {"WIFI_AND_MOBILE_DATA", "WIFI"})
    void shouldFailForNotIOS(Mode mode)
    {
