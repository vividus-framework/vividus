...
public class ByAppiumLocatorSearch extends AbstractElementAction implements IElementSearchAction
{
    private final AppiumHow how;

    public ByAppiumLocatorSearch(LocatorType type, AppiumHow how)
    {
        super(type);
        this.how = how;
    }
