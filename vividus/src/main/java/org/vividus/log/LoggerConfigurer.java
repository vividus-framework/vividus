...
public final class LoggerConfigurer
{
    ...
    {
        Predicate<String> log4j2XmlPredicate = Pattern.compile("log4j2-vividus.*\\.xml").asMatchPredicate();
        ...
        {
            String log4jConfigurationFiles = log4j2Resources.stream()
                    .map(Resource::getPath)
                    .collect(Collectors.joining(","));
            System.setProperty(ConfigurationFactory.CONFIGURATION_FILE_PROPERTY, log4jConfigurationFiles);
        }
    }
