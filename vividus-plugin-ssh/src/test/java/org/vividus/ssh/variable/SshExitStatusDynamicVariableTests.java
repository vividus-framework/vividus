...
class SshExitStatusDynamicVariableTests
{
    ...
    @InjectMocks private SshExitStatusDynamicVariable dynamicVariable;
    ...
    void shouldReturnExitStatus()
    {
        ...
        assertEquals(DynamicVariableCalculationResult.withValue("1"), dynamicVariable.calculateValue());
    }
