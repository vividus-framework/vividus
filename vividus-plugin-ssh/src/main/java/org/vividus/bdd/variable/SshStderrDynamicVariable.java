...
@Named("ssh-stderr")
public class SshStderrDynamicVariable implements DynamicVariable
{
    ...
    {
        return Optional.ofNullable(sshTestContext.getSshOutput()).map(SshOutput::getErrorStream).orElse(null);
    }
}
