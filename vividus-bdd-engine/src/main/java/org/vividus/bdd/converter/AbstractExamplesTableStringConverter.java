...
public abstract class AbstractExamplesTableStringConverter<T> extends AbstractParameterConverter<T>
{
    private Supplier<ExamplesTableFactory> examplesTableFactory;

    protected ExamplesTable createExamplesTable(String from)
    {
